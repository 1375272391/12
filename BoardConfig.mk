...
-include vendor/coolpad/m18s/BoardConfigVendor.mk

# use these headers 
TARGET_SPECIFIC_HEADER_PATH := device/coolpad/m18s/include
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 2684354560 #2.5G
...
#TARGET_KERNEL_SOURCE := kernel/coolpad/m18s
TARGET_KERNEL_ARCH := arm
TARGET_KERNEL_HEADER_ARCH := arm
#TARGET_KERNEL_CONFIG := cyanogen_m18s_defconfig
#TARGET_KERNEL_CROSS_COMPILE_PREFIX := aarch64-linux-android-
MTK_APPENDED_DTB_SUPPORT := yes
BOARD_KERNEL_IMAGE_NAME := Image.gz-dtb
# Stock_kernel
#TARGET_PREBUILT_KERNEL := device/coolpad/m18s/Image.gz-dtb
 
# prebuild kernel as fallback
TARGET_PREBUILT_KERNEL := device/coolpad/m18s/prebuilt/Image.gz-dtb
...
# system.prop
TARGET_SYSTEM_PROP := device/coolpad/m18s/system.prop

# CyanogenMod Hardware Hooks
BOARD_HARDWARE_CLASS := device/coolpad/m18s/cmhw/
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/coolpad/m18s/bluetooth
...
BOARD_EGL_CFG := device/coolpad/m18s/egl.cfg
#BOARD_EGL_WORKAROUND_BUG_10194508 := true

# SELinux
BOARD_SEPOLICY_DIRS := \
       device/coolpad/m18s/sepolicy
...
# recovery
#TARGET_RECOVERY_INITRC := device/coolpad/m18s/recovery/init.mt6735.rc
TARGET_RECOVERY_FSTAB := device/coolpad/m18s/recovery/root/fstab.mt6735
